namespace _7024Movies
{
    ...
    public partial class Movie
    {
        public static Movie FromJson(string json) => JsonConvert.DeserializeObject<Movie>(json, _7024Movies.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this Movie self) => JsonConvert.SerializeObject(self, _7024Movies.Converter.Settings);
    }
